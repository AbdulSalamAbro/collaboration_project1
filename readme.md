...
<div align="center">
  ...
  <h3><b>React Colloboration Project</b></h3>
...
**Setup-and-mobile-first** is a webpage built as a first project to showcase html and css and react skills of the Microverse program.
...
```sh
  cd my-folder
  git clone https://github.com/AbdulSalamAbro/personal-portfolio.git
```
...
```sh
  cd my-folder
  git https://github.com/AbdulSalamAbro/personal-portfolio.git
```
...
- https://abdulsalamabro.github.io/personal-portfolio/
